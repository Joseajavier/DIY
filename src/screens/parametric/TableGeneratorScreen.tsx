...
export default function TableGeneratorScreen({ navigation }: Props) {
  ...
  const output = useMemo(() => {
    return generateTable({
      ...
      legSection: parseFloat(legSection) || 0,
      topThickness: parseFloat(topThickness) || 25,
      hasApron,
      apronHeight: parseFloat(apronHeight) || 10,
      hasLowerShelf,
    });
  }, [length, width, height, legSection, topThickness, apronHeight, hasApron, hasLowerShelf]);
