...
export const TOOL_CATEGORIES: ToolCategory[] = [
  { id: 'cut',        name: 'Corte',                      nameKey: 'tools.categories.cut', icon: '🪚' },
  { id: 'drill',      name: 'Taladrado y atornillado',    nameKey: 'tools.categories.drill', icon: '🔩' },
  { id: 'routing',    name: 'Fresado y mecanizado',       nameKey: 'tools.categories.routing', icon: '⚙️' },
  { id: 'plane',      name: 'Cepillado y regruesado',     nameKey: 'tools.categories.plane', icon: '🪵' },
  { id: 'sand',       name: 'Lijado y acabado',           nameKey: 'tools.categories.sand', icon: '✨' },
  { id: 'join',       name: 'Unión y ensamblaje',         nameKey: 'tools.categories.join', icon: '🔗' },
  { id: 'clamp',      name: 'Sujeción y fijación',        nameKey: 'tools.categories.clamp', icon: '🔧' },
  { id: 'measure',    name: 'Medición y trazado',         nameKey: 'tools.categories.measure', icon: '📏' },
  { id: 'extract',    name: 'Aspiración y polvo',         nameKey: 'tools.categories.extract', icon: '💨' },
  { id: 'accessories',name: 'Accesorios y consumibles',   nameKey: 'tools.categories.accessories', icon: '🔄' },
  { id: 'battery',    name: 'Baterías y cargadores',      nameKey: 'tools.categories.battery', icon: '🔋' },
  { id: 'storage',    name: 'Organización y taller',      nameKey: 'tools.categories.storage', icon: '📦' },
  { id: 'machinery',  name: 'Maquinaria de taller',       nameKey: 'tools.categories.machinery', icon: '🏭' },
  { id: 'finish',     name: 'Acabado superficial',        nameKey: 'tools.categories.finish', icon: '🎨' },
];

export const TOOL_TYPES: ToolType[] = [
  { id: 'circular_saw', categoryId: 'cut', name: 'Sierra circular', nameKey: 'tools.types.circular_saw', icon: '🪚' },
  { id: 'plunge_saw', categoryId: 'cut', name: 'Sierra de inmersión / carril', nameKey: 'tools.types.plunge_saw', icon: '🪚' },
  { id: 'jigsaw', categoryId: 'cut', name: 'Sierra de calar', nameKey: 'tools.types.jigsaw', icon: '🪚' },
  { id: 'miter_saw', categoryId: 'cut', name: 'Sierra ingletadora', nameKey: 'tools.types.miter_saw', icon: '🪚' },
  { id: 'table_saw', categoryId: 'machinery', name: 'Sierra de mesa', nameKey: 'tools.types.table_saw', icon: '🏭' },
  { id: 'band_saw',  categoryId: 'machinery', name: 'Sierra de cinta', nameKey: 'tools.types.band_saw', icon: '🏭' },
  { id: 'reciprocating_saw', categoryId: 'cut', name: 'Sierra de sable', nameKey: 'tools.types.reciprocating_saw', icon: '🪚' },
  { id: 'multi_tool', categoryId: 'cut', name: 'Multiherramienta oscilante', nameKey: 'tools.types.multi_tool', icon: '🪚' },
  { id: 'drill_driver', categoryId: 'drill', name: 'Taladro atornillador', nameKey: 'tools.types.drill_driver', icon: '🔩' },
  { id: 'hammer_drill', categoryId: 'drill', name: 'Taladro percutor', nameKey: 'tools.types.hammer_drill', icon: '🔩' },
  { id: 'impact_driver', categoryId: 'drill', name: 'Atornillador de impacto', nameKey: 'tools.types.impact_driver', icon: '🔩' },
  { id: 'drill_press', categoryId: 'machinery', name: 'Taladro de columna', nameKey: 'tools.types.drill_press', icon: '🏭' },
  { id: 'pocket_hole', categoryId: 'drill', name: 'Sistema pocket hole', nameKey: 'tools.types.pocket_hole', icon: '🔩' },
  { id: 'domino_joiner', categoryId: 'drill', name: 'Fresadora de espigas (Domino)', nameKey: 'tools.types.domino_joiner', icon: '🔩' },
  { id: 'biscuit_joiner', categoryId: 'drill', name: 'Engalletadora', nameKey: 'tools.types.biscuit_joiner', icon: '🔩' },
  { id: 'orbital_sander', categoryId: 'sand',    name: 'Lijadora orbital / excéntrica',    nameKey: 'tools.types.orbital_sander', icon: '✨' },
  { id: 'belt_sander',    categoryId: 'sand',    name: 'Lijadora de banda',                nameKey: 'tools.types.belt_sander', icon: '✨' },
  { id: 'detail_sander',  categoryId: 'sand',    name: 'Lijadora de detalle',              nameKey: 'tools.types.detail_sander', icon: '✨' },
  { id: 'router',         categoryId: 'routing', name: 'Fresadora de superficie',          nameKey: 'tools.types.router', icon: '⚙️' },
  { id: 'trim_router',    categoryId: 'routing', name: 'Fresadora de cantos (recortadora)', nameKey: 'tools.types.trim_router', icon: '⚙️' },
  { id: 'electric_planer',categoryId: 'plane',   name: 'Cepillo eléctrico',               nameKey: 'tools.types.electric_planer', icon: '🪵' },
  { id: 'benchtop_planer',categoryId: 'machinery',name: 'Regruesadora de banco',           nameKey: 'tools.types.benchtop_planer', icon: '🏭' },
  { id: 'jointer_planer', categoryId: 'machinery',name: 'Cepilladora-regruesadora',        nameKey: 'tools.types.jointer_planer', icon: '🏭' },
  { id: 'laser_measure', categoryId: 'measure', name: 'Metro láser', nameKey: 'tools.types.laser_measure', icon: '📏' },
  { id: 'laser_level', categoryId: 'measure', name: 'Nivel láser', nameKey: 'tools.types.laser_level', icon: '📏' },
  { id: 'digital_caliper', categoryId: 'measure', name: 'Calibre digital', nameKey: 'tools.types.digital_caliper', icon: '📏' },
  { id: 'moisture_meter', categoryId: 'measure', name: 'Medidor de humedad', nameKey: 'tools.types.moisture_meter', icon: '📏' },
  { id: 'f_clamps', categoryId: 'clamp', name: 'Sargentos F', nameKey: 'tools.types.f_clamps', icon: '🔧' },
  { id: 'quick_clamps', categoryId: 'clamp', name: 'Sargentos rápidos', nameKey: 'tools.types.quick_clamps', icon: '🔧' },
  { id: 'corner_clamps', categoryId: 'clamp', name: 'Sargentos de esquina', nameKey: 'tools.types.corner_clamps', icon: '🔧' },
  { id: 'bench_vise', categoryId: 'clamp', name: 'Tornillo de banco', nameKey: 'tools.types.bench_vise', icon: '🔧' },
  { id: 'workbench', categoryId: 'clamp', name: 'Banco de trabajo', nameKey: 'tools.types.workbench', icon: '🔧' },
  { id: 'spray_gun', categoryId: 'finish', name: 'Pistola HVLP', nameKey: 'tools.types.spray_gun', icon: '🎨' },
  { id: 'nail_gun', categoryId: 'finish', name: 'Clavadora', nameKey: 'tools.types.nail_gun', icon: '🎨' },
  { id: 'heat_gun', categoryId: 'finish', name: 'Pistola de calor', nameKey: 'tools.types.heat_gun', icon: '🎨' },
  { id: 'shop_vac', categoryId: 'extract', name: 'Aspirador de taller', nameKey: 'tools.types.shop_vac', icon: '💨' },
  { id: 'dust_collector', categoryId: 'extract', name: 'Sistema de aspiración', nameKey: 'tools.types.dust_collector', icon: '💨' },

  // ── Fase 20 — tipos añadidos ────────────────────────────────
  // Corte manual
  { id: 'hand_saw',      categoryId: 'cut',   name: 'Serrucho manual / japonés',            nameKey: 'tools.types.hand_saw', icon: '🪚' },
  { id: 'saw_blade',     categoryId: 'accessories', name: 'Discos y hojas de sierra',        nameKey: 'tools.types.saw_blade', icon: '🔄' },
  // Lijado
  { id: 'abrasives',      categoryId: 'accessories', name: 'Abrasivos y lijas',               nameKey: 'tools.types.abrasives', icon: '🔄' },
  { id: 'router_bits',    categoryId: 'routing',     name: 'Fresas y accesorios de fresadora', nameKey: 'tools.types.router_bits', icon: '⚙️' },
  { id: 'spindle_sander', categoryId: 'machinery',   name: 'Lijadora de bobina (de columna)',  nameKey: 'tools.types.spindle_sander', icon: '🏭' },
  // Cepillado manual
  { id: 'hand_plane',    categoryId: 'plane', name: 'Cepillo manual',                        nameKey: 'tools.types.hand_plane', icon: '🪵' },
  // Medición
  { id: 'marking_square',categoryId: 'measure', name: 'Escuadras y falsos escuadros',        nameKey: 'tools.types.marking_square', icon: '📏' },
  { id: 'marking_gauge', categoryId: 'measure', name: 'Gramil y útiles de trazado',          nameKey: 'tools.types.marking_gauge', icon: '📏' },
  // Sujeción
  { id: 'guide_rail',    categoryId: 'clamp', name: 'Carriles guía y plantillas',            nameKey: 'tools.types.guide_rail', icon: '🔧' },
  // Acabado
  { id: 'brad_nailer',   categoryId: 'finish', name: 'Clavadora de cuadradillo',             nameKey: 'tools.types.brad_nailer', icon: '🎨' },

  // ── Ampliación taxonomía completa ────────────────────────────
  // Corte
  { id: 'scroll_saw',   categoryId: 'machinery', name: 'Sierra de marquetería',             nameKey: 'tools.types.scroll_saw', icon: '🏭' },
  { id: 'scoring_saw',  categoryId: 'cut',       name: 'Sierra de inmersión / incisión',    nameKey: 'tools.types.scoring_saw', icon: '🪚' },
  { id: 'chainsaw',     categoryId: 'cut',       name: 'Motosierra',                        nameKey: 'tools.types.chainsaw', icon: '🪚' },

  // Taladrado y atornillado — accesorios y variantes
  { id: 'screwdriver_tool', categoryId: 'drill', name: 'Atornillador',                      nameKey: 'tools.types.screwdriver_tool', icon: '🔩' },
  { id: 'wood_bits',        categoryId: 'drill', name: 'Brocas para madera',                nameKey: 'tools.types.wood_bits', icon: '🔩' },
  { id: 'forstner_bits',    categoryId: 'drill', name: 'Brocas Forstner',                   nameKey: 'tools.types.forstner_bits', icon: '🔩' },
  { id: 'spade_bits',       categoryId: 'drill', name: 'Brocas de pala',                    nameKey: 'tools.types.spade_bits', icon: '🔩' },
  { id: 'countersink',      categoryId: 'drill', name: 'Avellanadores',                     nameKey: 'tools.types.countersink', icon: '🔩' },
  { id: 'bit_set',          categoryId: 'drill', name: 'Sets de puntas y brocas',           nameKey: 'tools.types.bit_set', icon: '🔩' },
  { id: 'stapler',          categoryId: 'drill', name: 'Grapadora',                         nameKey: 'tools.types.stapler', icon: '🔩' },
  { id: 'pneumatic_nailer', categoryId: 'drill', name: 'Clavadora neumática',               nameKey: 'tools.types.pneumatic_nailer', icon: '🔩' },

  // Lijado y acabado de superficie — ampliación
  { id: 'delta_sander', categoryId: 'sand',      name: 'Lijadora delta / triangular',        nameKey: 'tools.types.delta_sander', icon: '✨' },
  { id: 'combo_sander', categoryId: 'machinery', name: 'Estación lijadora banda + disco',    nameKey: 'tools.types.combo_sander', icon: '🏭' },
  { id: 'polisher',     categoryId: 'sand',      name: 'Pulidora / satinadora',              nameKey: 'tools.types.polisher', icon: '✨' },
  { id: 'disc_sander',  categoryId: 'machinery', name: 'Lijadora de disco (estacionaria)',   nameKey: 'tools.types.disc_sander', icon: '🏭' },

  // Fresado y mecanizado — ampliación
  { id: 'mortiser', categoryId: 'routing',   name: 'Escopleadora',                         nameKey: 'tools.types.mortiser', icon: '⚙️' },
  { id: 'shaper',   categoryId: 'machinery', name: 'Tupi / fresadora de mesa',              nameKey: 'tools.types.shaper', icon: '🏭' },

  // Medición y trazado — ampliación
  { id: 'tape_measure',   categoryId: 'measure', name: 'Metro / cinta métrica',             nameKey: 'tools.types.tape_measure', icon: '📏' },
  { id: 'straight_edge',  categoryId: 'measure', name: 'Regla de precisión',                nameKey: 'tools.types.straight_edge', icon: '📏' },
  { id: 'protractor',     categoryId: 'measure', name: 'Goniómetro / transferidor de ángulos', nameKey: 'tools.types.protractor', icon: '📏' },
  { id: 'inclinometer',   categoryId: 'measure', name: 'Inclinómetro digital',              nameKey: 'tools.types.inclinometer', icon: '📏' },

  // Sujeción y fijación — ampliación
  { id: 'bar_clamps',     categoryId: 'clamp',  name: 'Gatos de barra',                    nameKey: 'tools.types.bar_clamps', icon: '🔧' },
  { id: 'spring_clamps',  categoryId: 'clamp',  name: 'Pinzas de resorte',                 nameKey: 'tools.types.spring_clamps', icon: '🔧' },
  { id: 'frame_clamps',   categoryId: 'clamp',  name: 'Útiles para marcos',                nameKey: 'tools.types.frame_clamps', icon: '🔧' },
  { id: 'pipe_clamps',    categoryId: 'clamp',  name: 'Sargentos de tubo',                 nameKey: 'tools.types.pipe_clamps', icon: '🔧' },
  { id: 'toggle_clamps',  categoryId: 'clamp',  name: 'Palomillas de apriete',             nameKey: 'tools.types.toggle_clamps', icon: '🔧' },
  { id: 'bench_dogs',     categoryId: 'clamp',  name: 'Perros de banco',                   nameKey: 'tools.types.bench_dogs', icon: '🔧' },

  // Acabado — ampliación
  { id: 'glue_gun',       categoryId: 'finish', name: 'Pistola de cola caliente',           nameKey: 'tools.types.glue_gun', icon: '🎨' },
  { id: 'finish_nailer',  categoryId: 'finish', name: 'Clavadora de acabado 16G',           nameKey: 'tools.types.finish_nailer', icon: '🎨' },

  // ── NUEVA CATEGORÍA: Unión y ensamblaje ─────────────────────
  { id: 'dowel_jig',      categoryId: 'join',   name: 'Plantilla de espigas redondas',     nameKey: 'tools.types.dowel_jig', icon: '🔗' },
  { id: 'wood_glue',      categoryId: 'join',   name: 'Colas y adhesivos para madera',     nameKey: 'tools.types.wood_glue', icon: '🔗' },
  { id: 'joint_hardware', categoryId: 'join',   name: 'Herrajes de unión y conectores',    nameKey: 'tools.types.joint_hardware', icon: '🔗' },
  { id: 'assembly_clamp', categoryId: 'join',   name: 'Prensas de ensamblaje',             nameKey: 'tools.types.assembly_clamp', icon: '🔗' },
  { id: 'frame_jig',      categoryId: 'join',   name: 'Útiles para marcos y puertas',      nameKey: 'tools.types.frame_jig', icon: '🔗' },
  { id: 'pocket_screw',   categoryId: 'join',   name: 'Tornillos y consumibles pocket hole', nameKey: 'tools.types.pocket_screw', icon: '🔗' },

  // ── MAQUINARIA DE TALLER — tipos propios ────────────────────
  { id: 'wood_lathe',     categoryId: 'machinery', name: 'Torno para madera',                 nameKey: 'tools.types.wood_lathe', icon: '🏭' },
  { id: 'cnc_router',     categoryId: 'machinery', name: 'CNC / Router CNC',                  nameKey: 'tools.types.cnc_router', icon: '🏭' },
  { id: 'planer_thicknesser', categoryId: 'machinery', name: 'Cepilladora + Regruesadora combinada', nameKey: 'tools.types.planer_thicknesser', icon: '🏭' },
  { id: 'edge_bander',    categoryId: 'machinery', name: 'Canteadora',                        nameKey: 'tools.types.edge_bander', icon: '🏭' },

  // ── ACCESORIOS Y CONSUMIBLES — tipos propios ─────────────────
  { id: 'chisel_set',     categoryId: 'accessories', name: 'Formones y escoplos',             nameKey: 'tools.types.chisel_set', icon: '🔄' },
  { id: 'marking_knife',  categoryId: 'accessories', name: 'Cuchillas de marcar',             nameKey: 'tools.types.marking_knife', icon: '🔄' },
  { id: 'lubricants',     categoryId: 'accessories', name: 'Lubricantes y mantenimiento',     nameKey: 'tools.types.lubricants', icon: '🔄' },
  { id: 'sandpaper',      categoryId: 'accessories', name: 'Papel de lija (hojas y rollos)',  nameKey: 'tools.types.sandpaper', icon: '🔄' },
  { id: 'finishing_products', categoryId: 'accessories', name: 'Barnices, aceites y ceras',   nameKey: 'tools.types.finishing_products', icon: '🔄' },

  // ── NUEVA CATEGORÍA: Baterías y cargadores ───────────────────
  { id: 'battery_pack',    categoryId: 'battery', name: 'Baterías',                        nameKey: 'tools.types.battery_pack', icon: '🔋' },
  { id: 'charger',         categoryId: 'battery', name: 'Cargadores',                      nameKey: 'tools.types.charger', icon: '🔋' },
  { id: 'battery_kit',     categoryId: 'battery', name: 'Kits de inicio con batería',      nameKey: 'tools.types.battery_kit', icon: '🔋' },
  { id: 'battery_station', categoryId: 'battery', name: 'Estaciones de carga',             nameKey: 'tools.types.battery_station', icon: '🔋' },

  // ── NUEVA CATEGORÍA: Organización y taller ───────────────────
  { id: 'toolbox',          categoryId: 'storage', name: 'Cajas de herramientas',           nameKey: 'tools.types.toolbox', icon: '📦' },
  { id: 'systainer',        categoryId: 'storage', name: 'Sistemas modulares (SYSTAINER / TSTAK)', nameKey: 'tools.types.systainer', icon: '📦' },
  { id: 'wall_storage',     categoryId: 'storage', name: 'Almacenamiento de pared',         nameKey: 'tools.types.wall_storage', icon: '📦' },
  { id: 'tool_cart',        categoryId: 'storage', name: 'Carros de herramientas',          nameKey: 'tools.types.tool_cart', icon: '📦' },
  { id: 'workbench_acc',    categoryId: 'storage', name: 'Accesorios de banco de trabajo',  nameKey: 'tools.types.workbench_acc', icon: '📦' },
];
...
export const TOOL_PRODUCTS: ToolProduct[] = [
  ...
  // ═══════════════════════════════════════════════════════════════
  // FASE 21 — Ampliación 15 tipos vacíos (tanda ChatGPT)
  // ═══════════════════════════════════════════════════════════════

  // ═══ MOTOSIERRA ═══
  { id: 'cw01', typeId: 'chainsaw', brandId: 'parkside', model: 'PKSA 20-Li B2', tier: 'basic', use: ['home'], power: 'battery', priceMin: 60, priceMax: 90, description: 'Motosierra compacta 20V para poda y leña ligera.', features: ['20V', 'Espada 30cm', 'Poda'], bestFor: 'Usuarios domésticos con uso ocasional' },
  { id: 'cw02', typeId: 'chainsaw', brandId: 'einhell', model: 'GE-LC 18/25 Li-Solo', tier: 'mid', use: ['home', 'workshop'], power: 'battery', priceMin: 90, priceMax: 130, description: '18V con espada corta para jardín y trabajos ligeros.', features: ['18V', '25cm', 'Sin cable'], bestFor: 'Quien quiere más comodidad que una de cable' },
  { id: 'cw03', typeId: 'chainsaw', brandId: 'ryobi', model: 'RCS1935B', tier: 'mid', use: ['home', 'workshop'], power: 'corded', priceMin: 110, priceMax: 140, description: 'Eléctrica de 1900W con espada de 35cm.', features: ['1900W', '35cm', 'Tensor lateral'], bestFor: 'Corte frecuente de leña en casa' },
  { id: 'cw04', typeId: 'chainsaw', brandId: 'makita', model: 'DUC353Z', tier: 'pro', use: ['workshop', 'construction'], power: 'battery', priceMin: 320, priceMax: 420, description: '36V X2 brushless, 35cm y empuje serio.', features: ['2x18V', 'Brushless', '35cm'], bestFor: 'Uso intensivo sin depender de cable' },

  // ═══ CLAVADORA NEUMÁTICA ═══
  { id: 'pn01', typeId: 'pneumatic_nailer', brandId: 'stanley', model: 'FN1664SP-E', tier: 'basic', use: ['home', 'workshop'], power: 'manual', priceMin: 140, priceMax: 190, description: 'Clavadora de acabado para puntas 16Ga hasta 64mm.', features: ['16Ga', 'Hasta 64mm', 'Acabado'], bestFor: 'Montaje ligero de marcos y remates' },
  { id: 'pn02', typeId: 'pneumatic_nailer', brandId: 'makita', model: 'AF506', tier: 'mid', use: ['home', 'workshop'], power: 'manual', priceMin: 95, priceMax: 130, description: 'Bradder 18Ga compacta para molduras y remates finos.', features: ['18Ga', '15-50mm', 'Ligera'], bestFor: 'Acabados limpios en taller doméstico' },
  { id: 'pn03', typeId: 'pneumatic_nailer', brandId: 'dewalt', model: 'DPN64C-XJ', tier: 'mid', use: ['workshop', 'construction'], power: 'manual', priceMin: 230, priceMax: 290, description: 'Clavadora neumática de bobina para madera y embalaje.', features: ['32-64mm', 'Bobina', 'Alta cadencia'], bestFor: 'Palets, embalaje y estructura ligera' },
  { id: 'pn04', typeId: 'pneumatic_nailer', brandId: 'makita', model: 'AN613', tier: 'pro', use: ['workshop', 'construction'], power: 'manual', priceMin: 300, priceMax: 360, description: 'Neumática profesional de bobina para clavo estructural.', features: ['38-65mm', 'Bobina', 'Pro'], bestFor: 'Uso diario en carpintería y obra' },

  // ═══ TUPI / FRESADORA DE MESA ═══
  { id: 'sh01', typeId: 'shaper', brandId: 'scheppach', model: 'HF50', tier: 'basic', use: ['home', 'workshop'], power: 'corded', priceMin: 300, priceMax: 380, description: 'Mesa de fresado compacta 1500W para perfiles básicos.', features: ['1500W', 'Mesa', 'Velocidad variable'], bestFor: 'Primer taller de ebanistería casera' },
  { id: 'sh02', typeId: 'shaper', brandId: 'scheppach', model: 'HF60', tier: 'mid', use: ['workshop'], power: 'corded', priceMin: 430, priceMax: 520, description: 'Fresadora de mesa mejor acabada y más estable.', features: ['1500W', 'Mesa grande', 'Ajuste fino'], bestFor: 'Aficionados avanzados que perfilarán a menudo' },
  { id: 'sh03', typeId: 'shaper', brandId: 'holzmann', model: 'FS160L', tier: 'mid', use: ['workshop'], power: 'corded', priceMin: 850, priceMax: 1100, description: 'Tupi estacionario de entrada para ebanistería real.', features: ['1500W', 'Eje 12mm', 'Mesa fundida'], bestFor: 'Taller pequeño que ya trabaja con serie corta' },
  { id: 'sh04', typeId: 'shaper', brandId: 'jet', model: 'JWS-34KX-M', tier: 'pro', use: ['workshop'], power: 'corded', priceMin: 2200, priceMax: 2600, description: 'Tupi profesional de gran rigidez y uso continuado.', features: ['230V', 'Mesa grande', 'Pro'], bestFor: 'Ebanistería profesional y moldurado serio' },

  // ═══ PERROS DE BANCO ═══
  { id: 'bd01', typeId: 'bench_dogs', brandId: 'wolfcraft', model: '6176000', tier: 'basic', use: ['home', 'workshop'], power: 'manual', priceMin: 28, priceMax: 40, description: 'Topes para mesa con agujeros de 20mm y sujeción rápida.', features: ['20mm', 'Banco MFT', 'Par'], bestFor: 'Mesas DIY con patrón de agujeros' },
  { id: 'bd02', typeId: 'bench_dogs', brandId: 'kreg', model: 'KKS1070', tier: 'mid', use: ['home', 'workshop'], power: 'manual', priceMin: 35, priceMax: 55, description: 'Bench dogs automáticos para posicionar y sujetar piezas.', features: ['Autoajuste', '20mm', 'Par'], bestFor: 'Usuarios de bancos tipo MFT o ACS' },
  { id: 'bd03', typeId: 'bench_dogs', brandId: 'bessey', model: 'BH-MFT', tier: 'mid', use: ['workshop'], power: 'manual', priceMin: 65, priceMax: 95, description: 'Perros de banco con apoyo firme para mesas MFT.', features: ['20mm', 'Acero', 'MFT'], bestFor: 'Taller que necesita repetibilidad y aguante' },
  { id: 'bd04', typeId: 'bench_dogs', brandId: 'sjobergs', model: '33293', tier: 'pro', use: ['workshop'], power: 'manual', priceMin: 95, priceMax: 130, description: 'Perros de banco premium en acero para banco serio.', features: ['Acero', 'Alta precisión', 'Par'], bestFor: 'Bancos profesionales Sjöbergs o equivalentes' },

  // ═══ PRENSAS DE ENSAMBLAJE ═══
  { id: 'ac01', typeId: 'assembly_clamp', brandId: 'wolfcraft', model: 'ES 22', tier: 'basic', use: ['home'], power: 'manual', priceMin: 16, priceMax: 28, description: 'Juego de escuadras de apriete para ensamblajes ligeros.', features: ['90°', 'Set', 'Ligero'], bestFor: 'Marcos y cajas pequeñas en bricolaje' },
  { id: 'ac02', typeId: 'assembly_clamp', brandId: 'irwin', model: 'QUICK-GRIP Corner Clamp', tier: 'mid', use: ['home', 'workshop'], power: 'manual', priceMin: 20, priceMax: 35, description: 'Prensa rápida a 90° para marcos, cajones y puertas.', features: ['90°', 'Una mano', 'Rápida'], bestFor: 'Montajes rápidos sin complicarse' },
  { id: 'ac03', typeId: 'assembly_clamp', brandId: 'bessey', model: 'BAN700', tier: 'mid', use: ['home', 'workshop'], power: 'manual', priceMin: 35, priceMax: 55, description: 'Prensa de cinta para marcos, polígonos y ensamblajes raros.', features: ['Cinta', 'Esquinas', '700mm+'], bestFor: 'Marcos y estructuras irregulares' },
  { id: 'ac04', typeId: 'assembly_clamp', brandId: 'bessey', model: 'KRE100-2K', tier: 'pro', use: ['workshop'], power: 'manual', priceMin: 70, priceMax: 110, description: 'Prensa de ensamblaje paralela para paneles y cuerpos.', features: ['1000mm', 'Paralela', 'Protectores'], bestFor: 'Encolado serio de paneles y muebles' },

  // ═══ ÚTILES PARA MARCOS Y PUERTAS ═══
  { id: 'fj01', typeId: 'frame_jig', brandId: 'wolfcraft', model: 'ES 22 Frame', tier: 'basic', use: ['home'], power: 'manual', priceMin: 16, priceMax: 28, description: 'Útil básico para mantener 90° en marcos ligeros.', features: ['90°', 'Set', 'Compacto'], bestFor: 'Cuadros, cajitas y marcos sencillos' },
  { id: 'fj02', typeId: 'frame_jig', brandId: 'kreg', model: 'KHCCC', tier: 'mid', use: ['home', 'workshop'], power: 'manual', priceMin: 30, priceMax: 45, description: 'Escuadra de apriete robusta para montaje y atornillado.', features: ['90°', 'Mordaza', 'Rápida'], bestFor: 'Cajas, frentes y pequeñas puertas' },
  { id: 'fj03', typeId: 'frame_jig', brandId: 'trend', model: 'VARIJIG', tier: 'mid', use: ['workshop'], power: 'manual', priceMin: 170, priceMax: 240, description: 'Sistema modular para plantillas de marcos y puertas.', features: ['Modular', 'Ajustable', 'Guía fresado'], bestFor: 'Quien fabrica varias medidas con precisión' },
  { id: 'fj04', typeId: 'frame_jig', brandId: 'incra', model: 'Miter Express 1000SE', tier: 'pro', use: ['workshop'], power: 'manual', priceMin: 360, priceMax: 460, description: 'Carro y guía de ingletes de alta precisión para marcos.', features: ['Inglete', 'Ajuste fino', 'Preciso'], bestFor: 'Marquetería y marcos con cortes repetibles' },

  // ═══ TORNO PARA MADERA ═══
  { id: 'wl01', typeId: 'wood_lathe', brandId: 'proxxon', model: 'DB 250', tier: 'basic', use: ['home'], power: 'corded', priceMin: 175, priceMax: 230, description: 'Mini torno para piezas pequeñas y modelismo en madera.', features: ['100W', '250mm', 'Mini'], bestFor: 'Objetos pequeños y aprendizaje' },
  { id: 'wl02', typeId: 'wood_lathe', brandId: 'scheppach', model: 'DM500T', tier: 'mid', use: ['home', 'workshop'], power: 'corded', priceMin: 250, priceMax: 320, description: 'Torno compacto con capacidad suficiente para patas cortas.', features: ['500W', '1000mm', 'Compacto'], bestFor: 'Aficionados que ya tornear piezas útiles' },
  { id: 'wl03', typeId: 'wood_lathe', brandId: 'holzmann', model: 'D 460 FXL', tier: 'mid', use: ['workshop'], power: 'corded', priceMin: 390, priceMax: 490, description: 'Torno intermedio con mejor bancada y control.', features: ['550W', '460mm', '4 velocidades'], bestFor: 'Taller aficionado avanzado' },
  { id: 'wl04', typeId: 'wood_lathe', brandId: 'jet', model: 'JWL-1221VS', tier: 'pro', use: ['workshop'], power: 'corded', priceMin: 950, priceMax: 1200, description: 'Torno variable profesional para trabajo fino y estable.', features: ['VS', '305mm', 'Pantalla rpm'], bestFor: 'Torneros exigentes y uso continuado' },

  // ═══ CNC / ROUTER CNC ═══
  { id: 'cnc01', typeId: 'cnc_router', brandId: 'katsu', model: '3018 Pro', tier: 'basic', use: ['home'], power: 'corded', priceMin: 220, priceMax: 320, description: 'Mini CNC de escritorio para grabado y corte muy ligero.', features: ['3018', 'Desktop', 'Hobby'], bestFor: 'Primer contacto con CNC en casa' },
  { id: 'cnc02', typeId: 'cnc_router', brandId: 'enjoywood', model: '3018 Pro Max', tier: 'mid', use: ['home', 'workshop'], power: 'corded', priceMin: 280, priceMax: 420, description: 'Desktop CNC mejor equipada para hobby avanzado.', features: ['3018', 'Mejor rigidez', 'GRBL'], bestFor: 'Makers que quieren afinar antes de subir de nivel' },
  { id: 'cnc03', typeId: 'cnc_router', brandId: 'holzmann', model: 'CL4060_230V', tier: 'mid', use: ['workshop'], power: 'corded', priceMin: 1900, priceMax: 2300, description: 'CNC de sobremesa ya seria para taller pequeño.', features: ['400x600', '230V', 'CNC'], bestFor: 'Taller que ya produce piezas de forma recurrente' },
  { id: 'cnc04', typeId: 'cnc_router', brandId: 'laguna', model: 'IQ Pro 24x36', tier: 'pro', use: ['workshop'], power: 'corded', priceMin: 5000, priceMax: 7000, description: 'Router CNC profesional compacto para producción real.', features: ['24x36', 'Pro', 'Mesa rígida'], bestFor: 'Producción profesional y serie corta' },

  // ═══ CEPILLADORA + REGRUESADORA ═══
  { id: 'pt01', typeId: 'planer_thicknesser', brandId: 'scheppach', model: 'HMS1070', tier: 'basic', use: ['home', 'workshop'], power: 'corded', priceMin: 330, priceMax: 420, description: 'Combinada compacta para poner en escuadra tablas pequeñas.', features: ['1500W', '254mm', '2 en 1'], bestFor: 'Aficionados que empiezan con madera maciza' },
  { id: 'pt02', typeId: 'planer_thicknesser', brandId: 'scheppach', model: 'HMS1080', tier: 'mid', use: ['home', 'workshop'], power: 'corded', priceMin: 430, priceMax: 520, description: 'Mejora de capacidad y estabilidad frente al modelo básico.', features: ['1500W', '254mm', 'Regrueso'], bestFor: 'Taller casero que ya trabaja más seguido' },
  { id: 'pt03', typeId: 'planer_thicknesser', brandId: 'holzmann', model: 'HOB260ABS', tier: 'mid', use: ['workshop'], power: 'corded', priceMin: 900, priceMax: 1050, description: 'Combinada de 260mm con salto claro en calidad de taller.', features: ['260mm', '230V', 'Mesa aluminio'], bestFor: 'Carpintería pequeña con ambición' },
  { id: 'pt04', typeId: 'planer_thicknesser', brandId: 'metabo', model: 'HC 260 C', tier: 'pro', use: ['workshop'], power: 'corded', priceMin: 1200, priceMax: 1450, description: 'Referencia conocida en 260mm para taller serio.', features: ['260mm', '230V', 'Precisa'], bestFor: 'Uso frecuente con buena fiabilidad' },

  // ═══ CANTEADORA ═══
  { id: 'eb01', typeId: 'edge_bander', brandId: 'virutex', model: 'EM25D', tier: 'mid', use: ['home', 'workshop'], power: 'corded', priceMin: 130, priceMax: 180, description: 'Aplicador de cola para canteado manual y reparaciones.', features: ['Manual', 'Cola caliente', 'Compacto'], bestFor: 'Pequeños trabajos y remates de tablero' },
  { id: 'eb02', typeId: 'edge_bander', brandId: 'virutex', model: 'AG98F', tier: 'mid', use: ['workshop'], power: 'corded', priceMin: 500, priceMax: 700, description: 'Canteadora portátil para PVC y chapa en obra o taller.', features: ['Portátil', 'Canteado', 'Precisa'], bestFor: 'Montadores y carpinteros de tablero' },
  { id: 'eb03', typeId: 'edge_bander', brandId: 'holzmann', model: 'KAM45PRO', tier: 'mid', use: ['workshop'], power: 'corded', priceMin: 800, priceMax: 1000, description: 'Canteadora estacionaria de entrada para taller pequeño.', features: ['Estacionaria', '45mm', 'Taller'], bestFor: 'Quien ya cantea con cierta regularidad' },
  { id: 'eb04', typeId: 'edge_bander', brandId: 'festool', model: 'CONTURO KA 65-Plus', tier: 'pro', use: ['workshop'], power: 'corded', priceMin: 3200, priceMax: 4200, description: 'La referencia portátil pro para canteado preciso.', features: ['Portátil', 'KA 65', 'Sistema'], bestFor: 'Montaje profesional de mobiliario y tablero' },

  // ═══ LUBRICANTES Y MANTENIMIENTO ═══
  { id: 'lu01', typeId: 'lubricants', brandId: 'ceys', model: 'Lubricante Multiusos 200 ml', tier: 'basic', use: ['home', 'workshop'], power: 'manual', priceMin: 4, priceMax: 7, description: 'Spray multiusos para mantenimiento general de herramienta.', features: ['200ml', 'Spray', 'Uso general'], bestFor: 'Mantenimiento básico en casa o taller' },
  { id: 'lu02', typeId: 'lubricants', brandId: 'kwb', model: 'PTFE Spray 400 ml', tier: 'mid', use: ['home', 'workshop'], power: 'manual', priceMin: 7, priceMax: 11, description: 'Lubricación seca para guías, mesas y mecanismos.', features: ['400ml', 'PTFE', 'Seco'], bestFor: 'Quien quiere menos suciedad en guías' },
  { id: 'lu03', typeId: 'lubricants', brandId: 'wolfcraft', model: 'Aceite de Corte 100 ml', tier: 'mid', use: ['workshop'], power: 'manual', priceMin: 6, priceMax: 10, description: 'Aceite de apoyo para corte y mecanizado de metal ligero.', features: ['100ml', 'Corte', 'Mantenimiento'], bestFor: 'Taller mixto con algo de herraje y ajuste' },
  { id: 'lu04', typeId: 'lubricants', brandId: 'cmt_orange_tools', model: 'Formula 2050', tier: 'pro', use: ['workshop'], power: 'manual', priceMin: 14, priceMax: 22, description: 'Limpiador y mantenimiento para hojas y fresas.', features: ['Limpiador', 'Fresas', 'Discos'], bestFor: 'Quien cuida consumibles caros y rendimiento' },

  // ═══ PAPEL DE LIJA ═══
  { id: 'sp01', typeId: 'sandpaper', brandId: 'kwb', model: '820404', tier: 'basic', use: ['home'], power: 'manual', priceMin: 4, priceMax: 7, description: 'Juego básico de hojas abrasivas para lijado manual.', features: ['Hojas', 'Surtido', 'Manual'], bestFor: 'Bricolaje puntual y repasos' },
  { id: 'sp02', typeId: 'sandpaper', brandId: 'wolfcraft', model: 'Rollo abrasivo 115mm x 5m P80', tier: 'basic', use: ['home', 'workshop'], power: 'manual', priceMin: 5, priceMax: 9, description: 'Rollo recortable para taco, borde y lijado rápido.', features: ['115mm', '5m', 'P80'], bestFor: 'Quien quiere cortar la lija a medida' },
  { id: 'sp03', typeId: 'sandpaper', brandId: 'bosch_green', model: 'C470', tier: 'mid', use: ['home', 'workshop'], power: 'manual', priceMin: 8, priceMax: 14, description: 'Abrasivo bien equilibrado para madera y pintura.', features: ['C470', 'Madera', 'Durable'], bestFor: 'Uso frecuente con acabado homogéneo' },
  { id: 'sp04', typeId: 'sandpaper', brandId: 'makita', model: 'P-43555', tier: 'mid', use: ['workshop'], power: 'manual', priceMin: 10, priceMax: 18, description: 'Pack de hojas abrasivas para lijado más intensivo.', features: ['Pack', 'Madera', 'Varios granos'], bestFor: 'Taller que gasta lija con ritmo' },

  // ═══ BARNICES, ACEITES Y CERAS ═══
  { id: 'fp01', typeId: 'finishing_products', brandId: 'ceys', model: 'Cera Reparadora M52233', tier: 'basic', use: ['home'], power: 'manual', priceMin: 5, priceMax: 8, description: 'Cera de retoque para pequeños golpes y arañazos.', features: ['Cera', 'Retoque', 'Madera'], bestFor: 'Reparaciones rápidas en muebles' },
  { id: 'fp02', typeId: 'finishing_products', brandId: 'ceys', model: 'Sellador Acrílico Madera 280 ml', tier: 'basic', use: ['home', 'workshop'], power: 'manual', priceMin: 8, priceMax: 12, description: 'Sellador para juntas y remates en carpintería interior.', features: ['280ml', 'Sellador', 'Pintable'], bestFor: 'Rematar encuentros antes de pintar o barnizar' },
  { id: 'fp03', typeId: 'finishing_products', brandId: 'ceys', model: 'Restaurador Madera M48404', tier: 'mid', use: ['home', 'workshop'], power: 'manual', priceMin: 5, priceMax: 9, description: 'Producto de renovación estética para superficies gastadas.', features: ['Restaurador', 'Madera', 'Rápido'], bestFor: 'Recuperar muebles sin una restauración profunda' },
  { id: 'fp04', typeId: 'finishing_products', brandId: 'ceys', model: 'Retocador Madera Nogal', tier: 'mid', use: ['home', 'workshop'], power: 'manual', priceMin: 6, priceMax: 10, description: 'Marcador de retoque para disimular rayas y cantos.', features: ['Nogal', 'Retoque', 'Preciso'], bestFor: 'Ajustes visuales rápidos en montaje y entrega' },

  // ═══ ESTACIONES DE CARGA ═══
  { id: 'bst01', typeId: 'battery_station', brandId: 'makita', model: 'DC18RD', tier: 'mid', use: ['workshop', 'construction'], power: 'corded', priceMin: 130, priceMax: 160, description: 'Cargador doble rápido para baterías LXT 14,4V/18V.', features: ['Doble', 'LXT', 'Rápido'], bestFor: 'Usuarios Makita con varias baterías' },
  { id: 'bst02', typeId: 'battery_station', brandId: 'hikoki', model: 'UC18YTSL', tier: 'mid', use: ['workshop', 'construction'], power: 'corded', priceMin: 150, priceMax: 220, description: 'Estación múltiple para varias baterías Hikoki 18V.', features: ['Multi', '18V', 'Carga simultánea'], bestFor: 'Equipos Hikoki con rotación de baterías' },
  { id: 'bst03', typeId: 'battery_station', brandId: 'bosch_blue', model: 'GAL 18V6-80', tier: 'pro', use: ['workshop', 'construction'], power: 'corded', priceMin: 170, priceMax: 240, description: 'Cargador de 6 bahías para flota Bosch Professional.', features: ['6 puertos', '18V', '80W'], bestFor: 'Taller o cuadrilla con parque Bosch' },
  { id: 'bst04', typeId: 'battery_station', brandId: 'dewalt', model: 'DCB104-QW', tier: 'pro', use: ['workshop', 'construction'], power: 'corded', priceMin: 230, priceMax: 280, description: 'Cargador rápido de 4 puertos para XR/FlexVolt.', features: ['4 puertos', 'XR', 'Rápido'], bestFor: 'Profesionales DeWalt con mucho ciclo de carga' },

  // ═══ ACCESORIOS DE BANCO DE TRABAJO ═══
  { id: 'wa01', typeId: 'workbench_acc', brandId: 'wolfcraft', model: '6901000', tier: 'basic', use: ['home', 'workshop'], power: 'manual', priceMin: 30, priceMax: 40, description: 'Tope/guía paralela para ampliar funciones en banco de corte.', features: ['Guía', 'Tope', 'Accesorio'], bestFor: 'Mejorar un banco doméstico sin gastar mucho' },
  { id: 'wa02', typeId: 'workbench_acc', brandId: 'sjobergs', model: 'Smart Clamper 33330', tier: 'mid', use: ['workshop'], power: 'manual', priceMin: 90, priceMax: 120, description: 'Mordaza rápida premium para banco de carpintero.', features: ['Sujeción', 'Banco', 'Rápida'], bestFor: 'Bancos serios con uso frecuente' },
  { id: 'wa03', typeId: 'workbench_acc', brandId: 'kreg', model: 'KWS500 Track Horse', tier: 'mid', use: ['home', 'workshop'], power: 'manual', priceMin: 220, priceMax: 320, description: 'Caballetes/soporte plegable modular para montar banco móvil.', features: ['Plegable', 'Modular', 'Carga alta'], bestFor: 'Taller flexible o montajes a domicilio' },
  { id: 'wa04', typeId: 'workbench_acc', brandId: 'festool', model: 'MFT-SP 488030', tier: 'pro', use: ['workshop'], power: 'manual', priceMin: 110, priceMax: 160, description: 'Elementos de apriete para mesas MFT con muy buen ajuste.', features: ['MFT', 'Apriete', 'Festool'], bestFor: 'Usuarios de sistema MFT que buscan precisión' },
];
